...
const buttonSidebar_1 = require("@/components/ui/buttonSidebar");
...
const Sidebar = React.forwardRef((_a, ref) => {
    ...
    if (isMobile) {
        return (<sheet_1.Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <sheet_1.SheetTitle className="hidden"></sheet_1.SheetTitle>
...
const SidebarTrigger = React.forwardRef((_a, ref) => {
    ...
    return (<buttonSidebar_1.ButtonSidebar ref={ref} data-sidebar="trigger" variant="ghost" size="icon" className={(0, utils_1.cn)("h-10 w-10", className)} onClick={(event) => {
            onClick === null || onClick === void 0 ? void 0 : onClick(event);
            toggleSidebar();
        }} {...props}>
      <lucide_react_1.PanelLeft />
      <span className="sr-only">Toggle Sidebar</span>
    </buttonSidebar_1.ButtonSidebar>);
});
